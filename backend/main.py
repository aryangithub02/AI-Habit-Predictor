...
def generate_plan(data: DynamicGoalPlanInput):
    """
    Endpoint to classify user goal, retrieve domain principles, and generate plan.
    """
    result = generate_dynamic_goal_plan(data)
    return result
